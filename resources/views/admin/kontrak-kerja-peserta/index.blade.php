<x-layouts.admin-app title="Kontrak kerja peserta">
    {{-- Header --}}
                ...
                @if ($datas->isNotEmpty())
                    @foreach ($datas as $item)
                        <tr>
                            ...
                            <td>{{ $item->users->jumlah_kontrak_kerja_diikuti }}</td>
                            <td>
                                <div class="flex flex-row gap-4">
                                    <a href="{{ route('admin.kontrak-kerja-peserta.show', [$item->id]) }}"
