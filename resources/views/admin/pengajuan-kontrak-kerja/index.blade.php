<x-layouts.admin-app title="Pengajuan kontrak kerja">
    {{-- Header --}}
    <div class="flex flex-row justify-between gap-4 flex-wrap">
        ...
        <form method="get" class="flex flex-row md:flex-1 gap-4 flex-wrap">
            <select name="status" class="select">
                ...
                @foreach (App\Enums\KontrakKerja\StatusPengajuanKontrakKerja::cases() as $status)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex flex-row gap-4">
                                    <a href="{{ route('admin.pengajuan-kontrak-kerja.edit', [$item->id]) }}"
