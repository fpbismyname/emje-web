<x-layouts.client-app title="Daftar pendaftaran pelatihan">
    {{-- Header --}}
                    ...
                    <li class="list-row">
                            ...
                            <div class="mt-2">
                                <div class="flex flex-row gap-4">
                                    ...
                                    <div class="flex flex-col">
                                        <div class="badge badge-sm badge-secondary">{{ $item->status->label() }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="flex flex-row gap-2">
                                <a href="{{ route('client.pelatihan.pendaftaran-pelatihan.show', [$item->id]) }}"
